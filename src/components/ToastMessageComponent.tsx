...
export const ToastMessageComponent = ({ height, width, iconColor = 'white', textColor = 'white', title, message, backgroundColor = '#93B1A6', iconSize = 30, iconName = "checkcircleo", visible, fontSize = 18 }: any) => {
