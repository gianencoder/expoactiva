...
export const translations = {
    ...
    en: {
        ...
        visibilityScree: {
            ...
            desactivarModoOscuro: 'Disable Dark Mode',
        },
        bottomTab: {
            inicio: "Home",
    ...
    pt: {
        ...
        ticketsScreen: {
            ...
            buyTicket: "CLIQUE AQUI PARA COMPRAR",
            noTicketsMessage: "Você não tem ingressos disponíveis",
            noTicketsImage: "../assets/images/sin-resultado.png",
            noTicketsSubtitle: "Você não tem ingressos disponíveis",
            buyButton: "COMPRAR",
